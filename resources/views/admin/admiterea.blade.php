@extends("admin.base")
@section("content")
    <p class="text-danger text-center"><b>Nota:</b> Pentru modificarea admiterii va rugam sa stergeti admiterea veche si sa adaugati din nou</p>
    <div class="col-md-6">
        <label class="text-info">Nume Admitere: </label> 
        <span class="text-info">(Ex.Regulamentul de admitere)</span>
        <input type="text" name="nume" class="form-control" placeholder="Nume admitere" style="margin-bottom: 10px;"/>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <h2 class="calibri" style="margin: 0px 0px 15px 0px;">Sigur doriti sa stergeti acest fisier?</h2>
